...
return [
    ...
    /*
     * Security and encryption config
     *
    ...
    'Cache' => [
         ...
         * Translation cache files are stored with this config.
         ...
         * config is used to store schema descriptions, and table listings
         * in connections.
         * Duration will be set to '+2 minutes' in bootstrap.php when debug = true
         */
        '_cake_model_' => [
     ...
     * re-use transport config across multiple profiles.
     *
    ...
    'Datasources' => [
        ...
        'default' => [
             ...
             * mysql config directive 'innodb_stats_on_metadata = 0'
     ...
     * Session config.
     *
     * Contains an array of settings to use for session config. The
     ...
     * - `defaults` - The default config set to use as a basis for your session.
